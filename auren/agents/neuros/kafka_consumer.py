...
class NEUROSKafkaConsumer:
    ...
    def __init__(self):
        ...
        # NEUROS API configuration
        self.neuros_url = os.getenv("NEUROS_API_URL", "http://localhost:8001")
    ...
    async def process_message(self, kafka_message: Dict[str, Any]):
        ...
        try:
            ...
            # This simulates a conversational biometric event
            biometric_event = {
    ...
    async def consume_messages(self):
        ...
        # Run Kafka consumer in thread since it's synchronous
