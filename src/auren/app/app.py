...
def get_static_path(filename):
    """Get path to static file using package resources"""
    return pkg_resources.resource_filename('auren.app', f'static/img/{filename}')

# Import from the new package structure
from auren.app import db_utils
from auren.app.pg_agents import PageAgents
from auren.app.pg_tasks import PageTasks
from auren.app.pg_crews import PageCrews
from auren.app.pg_tools import PageTools
from auren.app.pg_crew_run import PageCrewRun
from auren.app.pg_export_crew import PageExportCrew
from auren.app.pg_results import PageResults
from auren.app.pg_knowledge import PageKnowledge
from auren.app.llms import load_secrets_fron_env
from auren.utils.static_assets import asset_loader
